...
import {LogoutButton, SearchInput} from "../index"
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white dark:bg-[#000000] font-dmSans top-0 z-30 mx-0 mt-0 py-1 w-full border-b-2 border-zinc-200 dark:border-none">
        <div className="flex  justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div
                className="justify-between items-center w-full lg:flex lg:w-auto "
                id="mobile-menu-2"
            >

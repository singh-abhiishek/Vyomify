...
const PlaylistForm1 = ({ setIsOpen1, setIsOpen2 }) => {
  ...
  return (
    <div className='dark:bg-[#1c1c1c] p-5 py-4 w-[420px] rounded-xl relative'>
        <div className='flex flex-col gap-2 '>
            ...
            {/* playlist options */}
            <div className='mt-2'>
                <AllPlaylists selectedPlaylists={selectedPlaylists} setSelectedPlaylists={setSelectedPlaylists}/>
            </div>
            ...
            <div className='flex justify-between items-center p-0'>
                ...
                <div className={`rounded-xl ${noOfSelectedPlaylist === 0 ? "bg-[#363636] text-gray-500" : "bg-[#2b2b2b] text-gray-200 hover:bg-[#3a3a3a] hover:text-white transition-all duration-200 ease-in-out shadow-[inset_0_0_0_1px_#3d3d3d] "} px-2 py-0.5 

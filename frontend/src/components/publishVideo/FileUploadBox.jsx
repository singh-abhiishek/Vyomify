...
<div
  className={`w-full sm:w-3/4 md:w-2/3 lg:w-1/2 border rounded-2xl flex flex-col items-center justify-center 
    border-gray-500 p-4 sm:p-6 md:p-10 text-center cursor-pointer transition-all 
...
>
  ...
  <p className="text-base sm:text-lg font-semibold mt-2">Drag & Drop a {type} to upload</p>
